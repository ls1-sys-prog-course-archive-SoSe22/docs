...
- [Bugtracker](https://github.com/ls1-sys-prog-course-WiSe21-22/docs/issues)
...
- Task: [Implement sort(1)](https://github.com/ls1-sys-prog-course-WiSe21-22/task0-sort)
...
- Task: [Manual syscalls and tracing](https://github.com/ls1-sys-prog-course-WiSe21-22/task1-syscalls)
...
- Task: [Fuse filesystem](https://github.com/ls1-sys-prog-course-WiSe21-22/task2-fileio)
...
- Task: [Shell](https://github.com/ls1-sys-prog-course-WiSe21-22/task3-processes)
- Organizer: [Sebastian](https://github.com/)
- Deadline: TBD
- Points: 30
...
- Task: [Synchronization and Scalability](https://github.com/ls1-sys-prog-course-WiSe21-22/task4-concurrency)
- Organizer: [Pablo](https://github.com/)
- Deadline: TBD
- Points: 30
...
- Task: [Heap management implementation](https://github.com/ls1-sys-prog-course-WiSe21-22/task5-memory)
- Organizer: [Moritz](https://github.com/)
- Deadline: TBD
- Points: 40
...
- Task: [Sockets](https://github.com/ls1-sys-prog-course-WiSe21-22/task6-sockets)
- Organizer: [Simon](https://github.com/)
- Deadline: TBD
- Points: 40
...
- Task: [Performance](https://github.com/ls1-sys-prog-course-WiSe21-22/task7-performance)
...
- Task: [Container](https://github.com/ls1-sys-prog-course-WiSe21-22/task8-container)
